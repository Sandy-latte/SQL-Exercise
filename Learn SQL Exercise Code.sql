...
-get the longest album select * from albums 
...
INSERT INTO bands(name) VALUES ('xxx');
INSERT INTO albums(name,release_year,band_id) VALUES ('aaaa',1993,6);

-delete the band and album records in the previous step 
...
-Select the longest Song off each Album, return 'album, release year, duration'
